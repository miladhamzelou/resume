...
const data = {
  edu: [{
    ...
    description: 'The education was mainly C++ , C# , SQL based' + ' programming, and I also learned about' + ' SQL, PHP, MVC, UML and more.'
  }, {
    name: 'PHP-Academy',
  ...
  career: [{
    ...
    description: 'Work on customer project and improve my skills,' + 'work with: HTML5 , CSS3 , GULP , Boostrap , JavaScript, ' + 'JQwery '
  }, {
    name: 'PHP-Academy',
